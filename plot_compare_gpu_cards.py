...
def create_supplement_figure_3():
    gpu_timings = os.path.join('TimingData', 'gpu_timings.csv')
    ...
    ax1.annotate('A', xy=(0, 1), xycoords='axes fraction', fontsize=20,
                 xytext=(-60, 10), textcoords='offset points', ha='left', va='top')
    ...
    plt.savefig(os.path.join('Figures', 'supp_figure_3_compare_gpu.png'), bbox_tight='True')
