...
Parameter('bind_BaxA_Bcl2M_kf', 1e-06)
Parameter('bind_BaxA_Bcl2M_kr', 0.010000000000000002)
...
Rule('bind_BaxA_Bcl2M', Bax(bf=None, s1=None, s2=None, state='A') + Bcl2(bf=None, state='M') <> Bax(bf=1, s1=None, s2=None, state='A') % Bcl2(bf=1, state='M'), bind_BaxA_Bcl2M_kf, bind_BaxA_Bcl2M_kr)
...
Rule('bind_BadM_Bcl2M', Bad(bf=None, state='M') + Bcl2(bf=None, state='M') <> Bad(bf=1, state='M') % Bcl2(bf=1, state='M'), bind_BadM_Bcl2M_kf, bind_BadM_Bcl2M_kr)
